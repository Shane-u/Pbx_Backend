...
func main() {
	...
	asrAppID := "1347568144"
	asrSecretID := "AKIDCHE3lIco9RiuwyrbCevtkSyKXbUAg2FF"
	asrSecretKey := "tb9iP3Z4Z6XpfNvIUXP8g2BAypaFjAUb"
	asrModelType := "16k_zh"
	ttsEndpoint := "tts.tencentcloudapi.com"
	ttsAppID := "1347568144"
	ttsSecretID := "AKIDCHE3lIco9RiuwyrbCevtkSyKXbUAg2FF"
	ttsSecretKey := "tb9iP3Z4Z6XpfNvIUXP8g2BAypaFjAUb"
	vadModel := "silero"
	vadEndpoint := ""
	vadSecretKey := ""
	webhookAddr := ""
